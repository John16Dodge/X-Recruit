...
const MentorRequest = () => {
  ...
  return (
    <div className={`min-h-screen flex justify-center items-start relative overflow-x-hidden overflow-y-auto ${theme === 'dark' ? 'bg-gradient-to-br from-gray-800 to-gray-700 text-gray-100' : 'bg-white text-gray-700'}`}>
      <div className="absolute top-0 left-0 w-full h-full z-0 opacity-50 bg-gradient-to-br from-indigo-200 via-blue-400 to-purple-400 bg-[length:400%] animate-gradient" />
      
      <div className="w-[90%] max-w-[600px] my-12 p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg relative z-10 transition-all duration-300 animate-fadeIn">
